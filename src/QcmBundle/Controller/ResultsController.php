...
class ResultsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('@Qcm/Results/index.html.twig', array('allQcm' => $allQcm));
    }
    ...
    public function viewResultAction($qcmId)
    {
        ...
        return $this->render('@Qcm/Results/viewResult.html.twig', array('qcm' => $qcm,'allResults' => $results, 'stats' => $stats));
    }
