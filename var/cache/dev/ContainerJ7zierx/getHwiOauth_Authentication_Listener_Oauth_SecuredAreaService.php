...
$this->services['hwi_oauth.authentication.listener.oauth.secured_area'] = $instance = new \HWI\Bundle\OAuthBundle\Security\Http\Firewall\OAuthListener(${($_ = isset($this->services['security.token_storage']) ? $this->services['security.token_storage'] : ($this->services['security.token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())) && false ?: '_'}, ${($_ = isset($this->services['security.authentication.manager']) ? $this->services['security.authentication.manager'] : $this->getSecurity_Authentication_ManagerService()) && false ?: '_'}, ${($_ = isset($this->services['security.authentication.session_strategy.main']) ? $this->services['security.authentication.session_strategy.main'] : ($this->services['security.authentication.session_strategy.main'] = new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'))) && false ?: '_'}, $a, 'secured_area', $b, $d, ['use_forward' => false, 'check_path' => '/login_check', 'require_previous_session' => false], $c, ${($_ = isset($this->services['debug.event_dispatcher']) ? $this->services['debug.event_dispatcher'] : $this->getDebug_EventDispatcherService()) && false ?: '_'});

$instance->setResourceOwnerMap(${($_ = isset($this->services['hwi_oauth.resource_ownermap.secured_area']) ? $this->services['hwi_oauth.resource_ownermap.secured_area'] : $this->getHwiOauth_ResourceOwnermap_SecuredAreaService()) && false ?: '_'});
