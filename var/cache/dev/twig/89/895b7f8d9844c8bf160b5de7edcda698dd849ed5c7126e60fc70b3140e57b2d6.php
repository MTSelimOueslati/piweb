...
class __TwigTemplate_42fc6d9dc904e0663494ec784b1b7324d5708259ce57fa329d0a685fe662032a extends \Twig\Template
{
    ...
    public function block_hwi_oauth_content($context, array $blocks = [])
    {
        ...
        // line 4
        echo "    ";
        if (((isset($context["error"]) || array_key_exists("error", $context)) && ($context["error"] ?? $this->getContext($context, "error")))) {
            // line 5
            echo "        <span>";
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["owner"]) {
            ...
            echo "\">";
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans($context["owner"], [], "HWIOAuthBundle"), "html", null, true);
            echo "</a> <br />
    ";
        }
    ...
    {
        return array (  74 => 8,  69 => 7,  63 => 5,  60 => 4,  51 => 3,  29 => 1,);
    }
...
", "@HWIOAuth/Connect/login.html.twig", "C:\\wamp64\\www\\piweb\\vendor\\hwi\\oauth-bundle\\Resources\\views\\Connect\\login.html.twig");
    }
}
