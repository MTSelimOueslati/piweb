...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\AssociationsBundle/Resources/views'), '!Associations');
        $instance->addPath(($this->targetDirs[3].'\\src\\RecruitementBundle/Resources/views'), 'Recruitement');
        $instance->addPath(($this->targetDirs[3].'\\src\\RecruitementBundle/Resources/views'), '!Recruitement');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'RecruitementBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\RecruitementBundle'),
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'RecruitementBundle' => 'RecruitementBundle\\RecruitementBundle',
